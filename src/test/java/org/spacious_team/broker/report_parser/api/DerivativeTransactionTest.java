...
class DerivativeTransactionTest {
    ...
    void getTransactionCashFlows_valueInPointsIsZero() {
        DerivativeTransaction transaction = this.tr.toBuilder()
                .valueInPoints(BigDecimal.ZERO)
                .build();
        expectedCashFlows(transaction,
                getValueInPointsCashFlow(transaction),
                getValueCashFlow(transaction),
                getFeeCashFlow(transaction));
    }
